    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    markdownx.models.MarkdownxField(
                        blank=True, help_text='markdown syntax allowed', verbose_name='description'
                    ),
                ),
                ...
                (
                    'level',
                    models.CharField(
                        choices=[('U', 'User'), ('A', 'Admin')], default='U', max_length=1, verbose_name='level'
                    ),
                ),
                (
                    'category',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='app_catalog.category', verbose_name='category'
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'applications',
                    models.ManyToManyField(blank=True, to='app_catalog.Application', verbose_name='application'),
                ),
                (
                    'excluded_attributes',
                    models.ManyToManyField(
                ...
                (
                    'policy',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='app_catalog.policy', verbose_name='policy'
                    ),
                ),
            ],
            options={
