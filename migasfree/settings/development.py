...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'migasfree_backend'),
        'USER': os.environ.get('POSTGRES_USER', 'migasfree_backend'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'migasfree_backend'),
