...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='project',
            name='pms',
            field=models.CharField(choices=[('apt', 'apt'), ('dnf', 'dnf'), ('giman', 'plugins.giman'), ('gpkgmgr', 'plugins.gpkgmgr'), ('pacman', 'pacman'), ('winget', 'winget'), ('yum', 'yum'), ('zypper', 'zypper')], max_length=50, validators=[migasfree.core.validators.validate_project_pms], verbose_name='package management system'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excluded_attributes', models.ManyToManyField(blank=True, related_name='singularity_excluded', to='core.Attribute', verbose_name='excluded attributes')),
                ('included_attributes', models.ManyToManyField(blank=True, related_name='singularity_included', to='core.Attribute', verbose_name='included attributes')),
                ('property_att', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.property', verbose_name='Property')),
            ],
            options={
