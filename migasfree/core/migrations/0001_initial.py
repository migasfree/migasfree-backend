# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2015-12-11 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('packages_to_install', models.TextField(blank=True, help_text='Mandatory packages to install each time', null=True, verbose_name='To install')),
                ('packages_to_remove', models.TextField(blank=True, help_text='Mandatory packages to remove each time', null=True, verbose_name='To remove')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('longitude', models.FloatField(blank=True, null=True, verbose_name='longitude')),
                ('latitude', models.FloatField(blank=True, null=True, verbose_name='latitude')),
                ('excluded_attributes', models.ManyToManyField(blank=True, related_name='ExcludedAttributesGroup', to='core.Attribute', verbose_name='excluded')),
                ('included_attributes', models.ManyToManyField(blank=True, to='core.Attribute', verbose_name='included')),
            ],
            options={
                'verbose_name': 'Set of Attributes',
                'verbose_name_plural': 'Set of Attributes',
            },
        ),
        migrations.CreateModel(
            name='Store',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='If a computer has installed one of these packages it will be updated', to='core.Package', verbose_name='available'),
        ),
        migrations.AddField(
            model_name='deployment',
            name='excluded_attributes',
            field=models.ManyToManyField(blank=True, related_name='ExcludeAttribute', to='core.Attribute', verbose_name='excluded'),
        ),
        migrations.AddField(
            model_name='deployment',
            name='included_attributes',
            field=models.ManyToManyField(blank=True, to='core.Attribute', verbose_name='included'),
        ),
        migrations.AddField(
            model_name='deployment',
            name='project',
