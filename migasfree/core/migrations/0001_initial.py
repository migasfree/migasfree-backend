    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'platform',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='core.platform', verbose_name='platform'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text='This code will execute in the client computer, '
                        'and it must put in the standard output the value of the attribute correspondent to '
                        "this property.<br>The format of this value is 'name~description', where 'description' "
                        'is optional.<br><b>Example of code:</b><br>#Create an attribute with the name of computer '
                        'from bash<br> echo $HOSTNAME',
                        null=True,
                        verbose_name='code',
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'domains',
                    models.ManyToManyField(
                        blank=True, related_name='domains', to='core.Domain', verbose_name='domains'
                    ),
                ),
                (
                    'scope_preference',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='core.userprofile', verbose_name='user'
            ),
        ),
        migrations.CreateModel(
            name='PackageSet',
            fields=[
                ...
                (
                    'store',
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to='core.store', verbose_name='store'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(blank=True, null=True, verbose_name='default pre-included packages'),
                ),
                (
                    'default_included_packages',
                    models.TextField(blank=True, null=True, verbose_name='default included packages'),
                ),
                (
                    'default_excluded_packages',
                    models.TextField(blank=True, null=True, verbose_name='default excluded packages'),
                ),
                (
                    'source',
                    models.CharField(
                        choices=[('I', 'Internal'), ('E', 'External')], default='I', max_length=1, verbose_name='source'
                    ),
                ),
                ...
                (
                    'expire',
                    models.IntegerField(
                        default=1440, verbose_name='metadata cache minutes. Default 1440 minutes = 1 day'
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to='core.PackageSet',
                        verbose_name='available package sets',
                    ),
                ),
                (
                    'available_packages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'duration',
                    models.IntegerField(
                        default=1, validators=[django.core.validators.MinValueValidator(1)], verbose_name='duration'
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name='domain_tags', to='core.ServerAttribute', verbose_name='tags'
            ),
        ),
        migrations.AlterUniqueTogether(
            name='attribute',
