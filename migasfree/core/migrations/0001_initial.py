    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[(b'I', 'Internal'), (b'E', 'External')], default=b'I', max_length=1, verbose_name='source')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50, unique=True, verbose_name='name')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='comment')),
                ('excluded_attributes', models.ManyToManyField(blank=True, related_name='DomainExcludedAttribute', to='core.Attribute', verbose_name='excluded attributes')),
                ('included_attributes', models.ManyToManyField(blank=True, related_name='DomainIncludedAttribute', to='core.Attribute', verbose_name='included attributes')),
            ],
            options={
                'verbose_name': 'Domain',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excluded_attributes', models.ManyToManyField(blank=True, related_name='ScopeExcludedAttribute', to='core.Attribute', verbose_name='excluded attributes')),
                ('included_attributes', models.ManyToManyField(blank=True, related_name='ScopeIncludedAttribute', to='core.Attribute', verbose_name='included attributes')),
            ],
            options={
                'verbose_name': 'Scope',
        ...
        migrations.AddField(
            model_name='deployment',
            name='domain',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Domain', verbose_name='domain'),
        ),
        migrations.AddField(
            model_name='deployment',
