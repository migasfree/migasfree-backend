...
class PackageStatsViewSet(viewsets.ViewSet):
                ...
                examples=[
                    OpenApiExample(
                        ...
                        value={
                            ...
                            'outer': [
                                {'project_id': 5, 'store_id': 2, 'name': 'Main Store', 'value': 70},
                                {'project_id': 5, 'store_id': 3, 'name': 'Secondary Store', 'value': 50},
                                {'project_id': 7, 'store_id': 2, 'name': 'Main Store', 'value': 45},
                                {'project_id': 7, 'store_id': 4, 'name': 'Remote Store', 'value': 35},
                            ],
                        },
                    )
                ],
    ...
    def by_store(self, request):
        ...
        inner_aliases = {'project__id': 'project_id', 'project__name': 'name', 'count': 'value'}
        outer_aliases = {'project__id': 'project_id', 'store__id': 'store_id', 'store__name': 'name', 'count': 'value'}
