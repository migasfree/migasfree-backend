...
class DeviceStatsViewSet(viewsets.ViewSet):
        ...
        return Response(
            {
                ...
                'data': replace_keys(
                    ...
                    {'connection__name': 'name', 'connection__id': 'connection_id', 'count': 'value'},
                ),
            },
        ...
        return Response(
            {
                ...
                'total': Device.objects.count(),
                'data': replace_keys(
                    list(Device.group_by_model()), {'model__name': 'name', 'model__id': 'model_id', 'count': 'value'}
                ),
            },
            status=status.HTTP_200_OK,
        )
        ...
        return Response(
            {
                ...
                'data': replace_keys(
                    ...
                    {'manufacturer__name': 'name', 'manufacturer__id': 'manufacturer_id', 'count': 'value'},
                ),
            },
            status=status.HTTP_200_OK,
        )
    ...
    def models_by_project(self, request):
        ...
        for item in Model.group_by_project():
            ...
            data.append({'value': item['count'], 'drivers__project__id': item['drivers__project__id']})
